...
public class AuditLogJpaAdapter implements AuditLogPort {
    ...
    public AuditLogJpaAdapter(CoffeeMachineAuditLogRepository repository) {
        this.repository = repository;
    }

    @Override
    public void logAction(String actionName, long durationMillis) {
        CoffeeMachineAuditLogEntity entity =
                new CoffeeMachineAuditLogEntity(actionName, durationMillis);
